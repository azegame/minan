    ...
    <form class="w-auto">
        <div class="flex justify-end mr-6 mt-1">
            ...
            <div class="relative">
                ...
                <input type="search" id="search-box" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="タイトル検索" required>
