...
Route::post('/questionnaires/{questionnaireId}/{optionId}', [VoteController::class, 'vote'])->middleware('ajax.auth')->where('questionnaireId', '[0-9]+')->where('optionId', '[0-9]+')->name('questionnaires.vote');
